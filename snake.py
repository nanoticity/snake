...
import pygame, random, pygame.freetype, sys, pygame.mixer
pygame.init()
pygame.mixer.init()
...
def text(to_write, pos, size, color):
    font = pygame.freetype.Font("Acme-Regular.ttf")
    font.size = size
    font.fgcolor = (color[0], color[1], color[2])
    font.render_to(screen, (pos[0], pos[1]), str(to_write)) 
        ...
        for b in snake_list:
            if self.x == b.x and self.y == b.y:
                try:
                    ...
                    r = pygame.Rect(200, 200, 600, 600)
                    pygame.draw.rect(screen, (0, 0, 0), r, 20)
                    text("You Won!", (400, 480), 50, (0, 0, 0))
                    pygame.display.flip()
...
def end():
    ...
    r = pygame.Rect(200, 200, 600, 600)
    pygame.draw.rect(screen, (0, 0, 0), r, 20)
    text("You got a score of " + str(tummy), (250, 480), 50, (0, 0, 0))
    pygame.display.flip()
    pygame.time.wait(1000)
    sys.exit()
